...
const [primaryGenre, secondaryGenre, ...otherGenres] = genres; // the names do not matter. positions matter.
...
/* const temp = fetch("http://jsonplaceholder.typicode.com/todos");
console.log(temp); // pending promise
